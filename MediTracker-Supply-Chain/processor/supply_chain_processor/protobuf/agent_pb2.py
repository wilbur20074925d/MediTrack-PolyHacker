...
# source: supply_chain_processor/protobuf/agent.proto
...
Agent = _reflection.GeneratedProtocolMessageType('Agent', (_message.Message,), dict(
  DESCRIPTOR = _AGENT,
  __module__ = 'supply_chain_processor.protobuf.agent_pb2'
